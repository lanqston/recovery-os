...
function mechanism(e){
 ...
 else if(/launch|introduc|available|product|partnership|agreement|contract/.test(t)){kind='Product or commercial announcement';text='New products or commercial agreements can change expectations for demand, revenue and costs. The headline does not quantify incremental sales or profit.'}

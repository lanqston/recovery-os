const CACHE='recovery-os-research-v9';
const STATIC=['./','./index.html','./styles.css','./explorer.css','./tradingview-mode.css','./app.js','./research-chart.js','./explorer-prod-0.js','./explorer-prod-1.js','./explorer-prod-2.js','./explorer-prod-3.js','./explorer-prod-4.js','./explorer-prod-5.js','./explorer-prod-6.js','./explorer-prod-7.js','./explorer-prod-8.js','./explorer-prod-9.js','./explorer-prod-10.js','./free-hybrid.js?v=20260912b','./research-model.js?v=20260912b','./research-world.css?v=20260912b','./data/research/index.json','./manifest.webmanifest','./assets/icon.svg','./data/recovery-os.json','./data/research-seed.json','./data/research-seed-aapl-extra.json','./data/symbols-seed.json','./data/provider-capabilities.json'];

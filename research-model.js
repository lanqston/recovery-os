...
(()=>{
  ...
  function analyze(b,tr){
    ...
    const scenarios=tr?[
      {name:'Strengthening',tone:'positive',text:`${tr.catalyst?.summary||'The catalyst advances.'} Resolve the saved blocker before upgrading the thesis: ${tr.blocker||'the remaining setup requirements need verification.'}`,note:'Conditional path · not confirmed by this brief'},

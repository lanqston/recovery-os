...
def run():
    ...
    for name in ['movement-model.js','movement-ui.js','information-model.js','information-store.js','information-bridge.js','information-ui.js','information-world.js','market-world.js','research-universe.js','backend/cloudflare/worker.js','backend/cloudflare/information.mjs','backend/cloudflare/provider-client.mjs','backend/cloudflare/free-api.mjs','research-transport.js','data-freshness.js','refresh-controller.js','app.js','market-atlas.js']:
